// Generated by pmgen.py from techlibs/zeroasic/zeroasic_dsp_CREG.pmg

struct zeroasic_dsp_CREG_pm {
  Module *module;
  SigMap sigmap;
  ...
  struct state_zeroasic_dsp_packC_t {
    SigSpec argD;
    SigSpec argQ;
    SigBit clock;
    Cell* dsp;
    ...
    SigSpec sigC;
    SigSpec sigP;
  } st_zeroasic_dsp_packC;

  struct udata_zeroasic_dsp_packC_t {
    Cell* dff;
    SigSpec dffD;
    SigSpec dffQ;
    SigBit dffclock;
    std::function<SigSpec(const SigSpec&)> unextend;
  } ud_zeroasic_dsp_packC;
  ...
  zeroasic_dsp_CREG_pm(Module *module, const vector<Cell*> &cells) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
    setup(cells);
  }

  zeroasic_dsp_CREG_pm(Module *module) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
  }

  void setup(const vector<Cell*> &cells) {
    ud_zeroasic_dsp_packC.dff = nullptr;
    ud_zeroasic_dsp_packC.dffD = SigSpec();
    ud_zeroasic_dsp_packC.dffQ = SigSpec();
    ud_zeroasic_dsp_packC.dffclock = SigBit();
    ud_zeroasic_dsp_packC.unextend = std::function<SigSpec(const SigSpec&)>();
  ...
  ~zeroasic_dsp_CREG_pm() {
    for (auto cell : autoremove_cells)
      module->remove(cell);
  }

  int run_zeroasic_dsp_packC(std::function<void()> on_accept_f) {
    log_assert(setup_done);
    accept_cnt = 0;
    on_accept = on_accept_f;
    rollback = 0;
    st_zeroasic_dsp_packC.argD = SigSpec();
    st_zeroasic_dsp_packC.argQ = SigSpec();
    st_zeroasic_dsp_packC.clock = SigBit();
    st_zeroasic_dsp_packC.dsp = nullptr;
    st_zeroasic_dsp_packC.ff = nullptr;
    st_zeroasic_dsp_packC.ffC = nullptr;
    st_zeroasic_dsp_packC.ffoffset = int();
    st_zeroasic_dsp_packC.sigC = SigSpec();
    st_zeroasic_dsp_packC.sigP = SigSpec();
    block_0(1);
    log_assert(rollback_cache.empty());
    return accept_cnt;
  }

  int run_zeroasic_dsp_packC(std::function<void(zeroasic_dsp_CREG_pm&)> on_accept_f) {
    return run_zeroasic_dsp_packC([&](){on_accept_f(*this);});
  }

  int run_zeroasic_dsp_packC() {
    return run_zeroasic_dsp_packC([](){});
  }

  void block_subpattern_zeroasic_dsp_packC_(int recursion) { block_0(recursion); }
  void block_subpattern_zeroasic_dsp_packC_in_dffe(int recursion) { block_5(recursion); }

  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:40
  void block_0(int recursion YS_MAYBE_UNUSED) {
    Cell* &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.dsp;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffclock;
    std::function<SigSpec(const SigSpec&)> &unextend YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.unextend;
  ...
  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:46
  void block_1(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.dsp;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.clock;
    SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.sigC;
    SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffclock;
...
#define subpattern(pattern_name) do { block_subpattern_zeroasic_dsp_packC_ ## pattern_name (recursion+1); if (rollback) goto rollback_label; } while(0)
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:80
  void block_2(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.dsp;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.sigP;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.clock;
    Cell* &ffC YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.ffC;
    SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.sigC;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:90
  void block_3(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.dsp;
    Cell* const &ffC YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.ffC;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.sigC;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:102
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:123
  void block_6(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.clock;
    Cell* &ff YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.ff;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp_CREG.pmg:141
  void block_7(int recursion YS_MAYBE_UNUSED) {
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.clock;
    Cell* const &ff YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.ff;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_packC.argQ;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_packC.dffQ;
