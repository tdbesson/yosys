// Generated by pmgen.py from techlibs/zeroasic/zeroasic_dsp_cascade.pmg

struct zeroasic_dsp_cascade_pm {
  Module *module;
  SigMap sigmap;
  ...
  struct state_zeroasic_dsp_cascade_t {
    int AREG;
    int BREG;
    SigSpec argD;
    SigSpec argQ;
    ...
    Cell* nextP;
    Cell* nextP_shift17;
  } st_zeroasic_dsp_cascade;

  struct udata_zeroasic_dsp_cascade_t {
  ...
  zeroasic_dsp_cascade_pm(Module *module, const vector<Cell*> &cells) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
    setup(cells);
  }

  zeroasic_dsp_cascade_pm(Module *module) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
  }

  void setup(const vector<Cell*> &cells) {
    ud_zeroasic_dsp_cascade.chain = vector<std::tuple<Cell*,int,int,int>>();
    ud_zeroasic_dsp_cascade.dff = nullptr;
    ud_zeroasic_dsp_cascade.dffD = SigSpec();
    ud_zeroasic_dsp_cascade.dffQ = SigSpec();
    ud_zeroasic_dsp_cascade.dffclock = SigBit();
    ud_zeroasic_dsp_cascade.longest_chain = vector<std::tuple<Cell*,int,int,int>>();
    ud_zeroasic_dsp_cascade.unextend = std::function<SigSpec(const SigSpec&)>();
  ...
  ~zeroasic_dsp_cascade_pm() {
    for (auto cell : autoremove_cells)
      module->remove(cell);
  }

  int run_zeroasic_dsp_cascade(std::function<void()> on_accept_f) {
    log_assert(setup_done);
    accept_cnt = 0;
    on_accept = on_accept_f;
    rollback = 0;
    st_zeroasic_dsp_cascade.AREG = int();
    st_zeroasic_dsp_cascade.BREG = int();
    st_zeroasic_dsp_cascade.argD = SigSpec();
    st_zeroasic_dsp_cascade.argQ = SigSpec();
    st_zeroasic_dsp_cascade.clock = SigBit();
    st_zeroasic_dsp_cascade.ff = nullptr;
    st_zeroasic_dsp_cascade.ffoffset = int();
    st_zeroasic_dsp_cascade.first = nullptr;
    st_zeroasic_dsp_cascade.next = nullptr;
    st_zeroasic_dsp_cascade.nextP = nullptr;
    st_zeroasic_dsp_cascade.nextP_shift17 = nullptr;
    block_0(1);
    log_assert(rollback_cache.empty());
    return accept_cnt;
  }

  int run_zeroasic_dsp_cascade(std::function<void(zeroasic_dsp_cascade_pm&)> on_accept_f) {
    return run_zeroasic_dsp_cascade([&](){on_accept_f(*this);});
  }

  int run_zeroasic_dsp_cascade() {
    return run_zeroasic_dsp_cascade([](){});
  }

  void block_subpattern_zeroasic_dsp_cascade_(int recursion) { block_0(recursion); }
  void block_subpattern_zeroasic_dsp_cascade_in_dffe(int recursion) { block_11(recursion); }
  void block_subpattern_zeroasic_dsp_cascade_tail(int recursion) { block_4(recursion); }

  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:59
  void block_0(int recursion YS_MAYBE_UNUSED) {
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffclock;
    vector<std::tuple<Cell*,int,int,int>> &longest_chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.longest_chain;
    std::function<SigSpec(const SigSpec&)> &unextend YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.unextend;
...
#define subpattern(pattern_name) do { block_subpattern_zeroasic_dsp_cascade_ ## pattern_name (recursion+1); if (rollback) goto rollback_label; } while(0)
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:66
  void block_1(int recursion YS_MAYBE_UNUSED) {
    Cell* &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:75
  void block_2(int recursion YS_MAYBE_UNUSED) {
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
      ...
      for (int i = 1; i < GetSize(longest_chain); i++) {
        ...
        if (i % MAX_DSP_CASCADE > 0) {
          ...
          if (BREG >= 0) {
            ...
            if (dsp->type.in(id_b_DSP48A, id_b_DSP48A1)) {
              // According to UG389 p9 [https://www.zeroasic.com/support/documentation/user_guides/ug389.pdf]
            ...
            if (dsp->type.in(id_b_DSP48E1)) {
              ...
              // According to UG389 p13 [https://www.zeroasic.com/support/documentation/user_guides/ug389.pdf]
...
#undef finish
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:188
  void block_4(int recursion YS_MAYBE_UNUSED) {
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    Cell* const &next YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.next;
    Cell* &nextP YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:199
  void block_5(int recursion YS_MAYBE_UNUSED) {
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    Cell* const &next YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.next;
    Cell* const &nextP YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP;
    Cell* &nextP_shift17 YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP_shift17;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:210
  void block_6(int recursion YS_MAYBE_UNUSED) {
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    Cell* const &nextP YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP;
    Cell* const &nextP_shift17 YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP_shift17;
    Cell* &next YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.next;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:238
  void block_7(int recursion YS_MAYBE_UNUSED) {
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    Cell* const &next YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.next;
    Cell* const &nextP YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP;
    Cell* const &nextP_shift17 YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP_shift17;
    int &AREG YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.AREG;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.clock;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:279
  void block_8(int recursion YS_MAYBE_UNUSED) {
    const int &AREG YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.AREG;
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    Cell* const &next YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.next;
    Cell* const &nextP YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP;
    Cell* const &nextP_shift17 YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP_shift17;
    int &BREG YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.BREG;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.clock;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:329
  void block_9(int recursion YS_MAYBE_UNUSED) {
    const int &AREG YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.AREG;
    const int &BREG YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.BREG;
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.clock;
    Cell* const &first YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.first;
    Cell* const &next YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.next;
    Cell* const &nextP YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP;
    Cell* const &nextP_shift17 YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.nextP_shift17;
...
#undef finish
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:362
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:383
  void block_12(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.clock;
    Cell* &ff YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.ff;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffQ;
  ...
  // techlibs/zeroasic/zeroasic_dsp_cascade.pmg:401
  void block_13(int recursion YS_MAYBE_UNUSED) {
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.clock;
    Cell* const &ff YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.ff;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_cascade.argQ;
    vector<std::tuple<Cell*,int,int,int>> &chain YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.chain;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_cascade.dffD;
