// Generated by pmgen.py from techlibs/zeroasic/zeroasic_dsp48a.pmg

struct zeroasic_dsp48a_pm {
  Module *module;
  SigMap sigmap;
  ...
  struct state_zeroasic_dsp48a_pack_t {
    SigSpec argD;
    SigSpec argQ;
    SigBit clock;
    Cell* dsp;
    ...
    SigSpec sigM;
    SigSpec sigP;
  } st_zeroasic_dsp48a_pack;

  struct udata_zeroasic_dsp48a_pack_t {
    Cell* dff;
    SigSpec dffD;
    SigSpec dffQ;
    SigBit dffclock;
  } ud_zeroasic_dsp48a_pack;
  ...
  zeroasic_dsp48a_pm(Module *module, const vector<Cell*> &cells) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
    setup(cells);
  }

  zeroasic_dsp48a_pm(Module *module) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
  }

  void setup(const vector<Cell*> &cells) {
    ud_zeroasic_dsp48a_pack.dff = nullptr;
    ud_zeroasic_dsp48a_pack.dffD = SigSpec();
    ud_zeroasic_dsp48a_pack.dffQ = SigSpec();
    ud_zeroasic_dsp48a_pack.dffclock = SigBit();
  ...
  int run_zeroasic_dsp48a_pack(std::function<void()> on_accept_f) {
    log_assert(setup_done);
    accept_cnt = 0;
    on_accept = on_accept_f;
    rollback = 0;
    st_zeroasic_dsp48a_pack.argD = SigSpec();
    st_zeroasic_dsp48a_pack.argQ = SigSpec();
    st_zeroasic_dsp48a_pack.clock = SigBit();
    st_zeroasic_dsp48a_pack.dsp = nullptr;
    st_zeroasic_dsp48a_pack.ff = nullptr;
    st_zeroasic_dsp48a_pack.ffA0 = nullptr;
    st_zeroasic_dsp48a_pack.ffA1 = nullptr;
    st_zeroasic_dsp48a_pack.ffB0 = nullptr;
    st_zeroasic_dsp48a_pack.ffB1 = nullptr;
    st_zeroasic_dsp48a_pack.ffD = nullptr;
    st_zeroasic_dsp48a_pack.ffM = nullptr;
    st_zeroasic_dsp48a_pack.ffP = nullptr;
    st_zeroasic_dsp48a_pack.postAdd = nullptr;
    st_zeroasic_dsp48a_pack.postAddAB = IdString();
    st_zeroasic_dsp48a_pack.postAddMux = nullptr;
    st_zeroasic_dsp48a_pack.postAddMuxAB = IdString();
    st_zeroasic_dsp48a_pack.preAdd = nullptr;
    st_zeroasic_dsp48a_pack.sigA = SigSpec();
    st_zeroasic_dsp48a_pack.sigB = SigSpec();
    st_zeroasic_dsp48a_pack.sigC = SigSpec();
    st_zeroasic_dsp48a_pack.sigD = SigSpec();
    st_zeroasic_dsp48a_pack.sigM = SigSpec();
    st_zeroasic_dsp48a_pack.sigP = SigSpec();
    block_0(1);
    log_assert(rollback_cache.empty());
    return accept_cnt;
  }

  int run_zeroasic_dsp48a_pack(std::function<void(zeroasic_dsp48a_pm&)> on_accept_f) {
    return run_zeroasic_dsp48a_pack([&](){on_accept_f(*this);});
  }

  int run_zeroasic_dsp48a_pack() {
    return run_zeroasic_dsp48a_pack([](){});
  }

  void block_subpattern_zeroasic_dsp48a_pack_(int recursion) { block_0(recursion); }
  void block_subpattern_zeroasic_dsp48a_pack_in_dffe(int recursion) { block_16(recursion); }
  void block_subpattern_zeroasic_dsp48a_pack_out_dffe(int recursion) { block_20(recursion); }

  // techlibs/zeroasic/zeroasic_dsp48a.pmg:52
  void block_0(int recursion YS_MAYBE_UNUSED) {
    Cell* &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:56
  void block_1(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
    SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
...
#define subpattern(pattern_name) do { block_subpattern_zeroasic_dsp48a_pack_ ## pattern_name (recursion+1); if (rollback) goto rollback_label; } while(0)
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:94
  void block_2(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:108
  void block_3(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    Cell* &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:127
  void block_4(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:135
  void block_5(int recursion YS_MAYBE_UNUSED) {
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ffB0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB0;
    SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:166
  void block_6(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    Cell* const &ffB0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB0;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ffA0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffA0;
    Cell* &ffA1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffA1;
    SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:208
  void block_7(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    Cell* const &ffA0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffA0;
    Cell* const &ffA1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffA1;
    Cell* const &ffB0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB0;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffD;
    SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:221
  void block_8(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffB0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB0;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
    SigSpec &argD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argD;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffM;
    SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:239
  void block_9(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argD;
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.dsp;
    Cell* const &ffA0 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffA0;
    ...
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffB1;
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffM;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigP;
    Cell* &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAdd;
    IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddAB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:258
  void block_10(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffM;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:266
  void block_11(int recursion YS_MAYBE_UNUSED) {
    ...
    SigSpec &argD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argD;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ffP YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffP;
    SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:293
  void block_12(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffM;
    Cell* const &ffP YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ffP;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    ...
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigP;
    Cell* &postAddMux YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddMux;
    IdString &postAddMuxAB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddMuxAB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:305
  void block_13(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddAB;
    Cell* const &postAddMux YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddMux;
    const IdString &postAddMuxAB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.postAddMuxAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigB;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.sigD;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:310
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:321
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:342
  void block_17(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* &ff YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ff;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:360
  void block_18(int recursion YS_MAYBE_UNUSED) {
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.clock;
    Cell* const &ff YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.ff;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp48a_pack.argQ;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp48a_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:387
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:395
  ...
  // techlibs/zeroasic/zeroasic_dsp48a.pmg:410
