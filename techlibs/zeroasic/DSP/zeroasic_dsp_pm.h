// Generated by pmgen.py from techlibs/zeroasic/zeroasic_dsp.pmg

struct zeroasic_dsp_pm {
  Module *module;
  SigMap sigmap;
  ...
  struct state_zeroasic_dsp_pack_t {
    SigSpec argD;
    SigSpec argQ;
    SigBit clock;
    Cell* dsp;
    ...
    SigSpec sigM;
    SigSpec sigP;
  } st_zeroasic_dsp_pack;

  struct udata_zeroasic_dsp_pack_t {
    Cell* dff;
    SigSpec dffD;
    SigSpec dffQ;
    SigBit dffclock;
  } ud_zeroasic_dsp_pack;
  ...
  zeroasic_dsp_pm(Module *module, const vector<Cell*> &cells) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
    setup(cells);
  }

  zeroasic_dsp_pm(Module *module) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
  }

  void setup(const vector<Cell*> &cells) {
    ud_zeroasic_dsp_pack.dff = nullptr;
    ud_zeroasic_dsp_pack.dffD = SigSpec();
    ud_zeroasic_dsp_pack.dffQ = SigSpec();
    ud_zeroasic_dsp_pack.dffclock = SigBit();
  ...
  int run_zeroasic_dsp_pack(std::function<void()> on_accept_f) {
    log_assert(setup_done);
    accept_cnt = 0;
    on_accept = on_accept_f;
    rollback = 0;
    st_zeroasic_dsp_pack.argD = SigSpec();
    st_zeroasic_dsp_pack.argQ = SigSpec();
    st_zeroasic_dsp_pack.clock = SigBit();
    st_zeroasic_dsp_pack.dsp = nullptr;
    st_zeroasic_dsp_pack.ff = nullptr;
    st_zeroasic_dsp_pack.ffA1 = nullptr;
    st_zeroasic_dsp_pack.ffA2 = nullptr;
    st_zeroasic_dsp_pack.ffAD = nullptr;
    st_zeroasic_dsp_pack.ffB1 = nullptr;
    st_zeroasic_dsp_pack.ffB2 = nullptr;
    st_zeroasic_dsp_pack.ffD = nullptr;
    st_zeroasic_dsp_pack.ffM = nullptr;
    st_zeroasic_dsp_pack.ffP = nullptr;
    st_zeroasic_dsp_pack.overflow = nullptr;
    st_zeroasic_dsp_pack.postAdd = nullptr;
    st_zeroasic_dsp_pack.postAddAB = IdString();
    st_zeroasic_dsp_pack.postAddMux = nullptr;
    st_zeroasic_dsp_pack.postAddMuxAB = IdString();
    st_zeroasic_dsp_pack.preAdd = nullptr;
    st_zeroasic_dsp_pack.sigA = SigSpec();
    st_zeroasic_dsp_pack.sigB = SigSpec();
    st_zeroasic_dsp_pack.sigC = SigSpec();
    st_zeroasic_dsp_pack.sigD = SigSpec();
    st_zeroasic_dsp_pack.sigM = SigSpec();
    st_zeroasic_dsp_pack.sigP = SigSpec();
    block_0(1);
    log_assert(rollback_cache.empty());
    return accept_cnt;
  }

  int run_zeroasic_dsp_pack(std::function<void(zeroasic_dsp_pm&)> on_accept_f) {
    return run_zeroasic_dsp_pack([&](){on_accept_f(*this);});
  }

  int run_zeroasic_dsp_pack() {
    return run_zeroasic_dsp_pack([](){});
  }

  void block_subpattern_zeroasic_dsp_pack_(int recursion) { block_0(recursion); }
  void block_subpattern_zeroasic_dsp_pack_in_dffe(int recursion) { block_17(recursion); }
  void block_subpattern_zeroasic_dsp_pack_out_dffe(int recursion) { block_21(recursion); }

  // techlibs/zeroasic/zeroasic_dsp.pmg:69
  void block_0(int recursion YS_MAYBE_UNUSED) {
    Cell* &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:73
  void block_1(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
    SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
...
#define subpattern(pattern_name) do { block_subpattern_zeroasic_dsp_pack_ ## pattern_name (recursion+1); if (rollback) goto rollback_label; } while(0)
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:113
  void block_2(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ffAD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffAD;
    SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:127
  void block_3(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffAD;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    Cell* &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:148
  void block_4(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffAD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:158
  void block_5(int recursion YS_MAYBE_UNUSED) {
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ffA1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA1;
    Cell* &ffA2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA2;
    Cell* &ffAD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffAD;
    SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:210
  void block_6(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    Cell* const &ffA1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA1;
    Cell* const &ffA2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA2;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffAD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB1;
    Cell* &ffB2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB2;
    SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:252
  void block_7(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    Cell* const &ffA1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA1;
    Cell* const &ffA2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA2;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffAD;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB1;
    Cell* const &ffB2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB2;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffD;
    SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:265
  void block_8(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB1;
    Cell* const &ffB2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB2;
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
    SigSpec &argD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argD;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffM;
    SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:283
  void block_9(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argD;
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.dsp;
    Cell* const &ffA1 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffA1;
    ...
    Cell* const &ffB2 YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffB2;
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffM;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigP;
    Cell* &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAdd;
    IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddAB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:302
  void block_10(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffM;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:310
  void block_11(int recursion YS_MAYBE_UNUSED) {
    ...
    SigSpec &argD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argD;
    SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ffP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffP;
    SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:337
  void block_12(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffM;
    Cell* const &ffP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffP;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    ...
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigP;
    Cell* &postAddMux YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddMux;
    IdString &postAddMuxAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddMuxAB;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:349
  void block_13(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddAB;
    Cell* const &postAddMux YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddMux;
    const IdString &postAddMuxAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddMuxAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigB;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigD;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:359
  void block_14(int recursion YS_MAYBE_UNUSED) {
    ...
    const SigSpec &sigM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.sigP;
    Cell* &overflow YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.overflow;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:371
  void block_15(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffM YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffM;
    Cell* const &ffP YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ffP;
    Cell* const &overflow YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.overflow;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddAB;
    Cell* const &postAddMux YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddMux;
    const IdString &postAddMuxAB YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.postAddMuxAB;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:382
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:403
  void block_18(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* &ff YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ff;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffclock;
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:421
  void block_19(int recursion YS_MAYBE_UNUSED) {
    const SigBit &clock YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.clock;
    Cell* const &ff YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.ff;
    SigSpec &argQ YS_MAYBE_UNUSED = st_zeroasic_dsp_pack.argQ;
    Cell* &dff YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_zeroasic_dsp_pack.dffQ;
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:448
...
rollback_label:
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:456
  ...
  // techlibs/zeroasic/zeroasic_dsp.pmg:471
